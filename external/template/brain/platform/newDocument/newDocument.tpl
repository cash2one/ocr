...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1490786085/css/newDocument/newDocument.style.css">
</head>
...
<script src="//ai.bdstatic.com/dist/1490786085/js/newDocument/newDocument.js"></script>
<script>
    (function(){
