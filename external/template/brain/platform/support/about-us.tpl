...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1492140185/css/support/about-us.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<section class="about-introduction container">
    ...
    <img class="about-list-img"  src="//ai.bdstatic.com/dist/1492140185/ai_images/support/about-us/lc-pic.png">
</section>
{%if $userInfo eq Null%}
...
<script src="//ai.bdstatic.com/dist/1492140185/js/support/about-us.js"></script>
