...
<section class="about-introduction container">
    ...
    <div class="about-list-infor">百度大脑面向企业/机构/创业者/开发者推出的以 API 或 SDK 的形式，将人工智能的图像、语音、自然语言处理、用户画像等核心能力对外共享。<br>
    ...
    <div class="about-list-infor">AI超级计算机，是专门为基于人工智能应用所定制的国内最早的超高速异构计算集群，融合了百度自主研发高密度的异构计算服务器，GPU Box、FPGA等，是构成百度大脑的核心基础技术。<br>
    ...
    <div class="about-list-infor">PaddlePaddle——Parallel Distributed Deep Learning（并行分布深度学习），能够充分利用多机多显卡计算资源，用无填充的循环神经网络，进行稀疏化的计算和精细的计算优化。<br>
    ...
    <div class="about-list-infor">百度Deep Speech 2系统只通过大量的数据，就可以自动掌握语言的全部细节以及人类的说话方式。作为第一个生产级别的语音引擎，通过“端到端深度学习技术”，整个语音系统被极大的简化。此技术让我们可以运用相同的技术去打造不同语言的语音识别系统。目前，它在口语识别的准确度方面十分惊人, 达到了97%的准确率。被MIT科技评论评为2016年十大突破技术之一。<br>
    ...
    <div class="about-list-infor">百度大脑图像处理技术基于深度学习算法，智能识别图像类别、内容和含义，支持基于图像识别的场景应用。人脸识别FDDB第一名，准确率98%，召回90%；人脸识别LFW第一名；ICDAR竞赛4项世界第一。<br>
        提供的主要功能：<br>
    ...
    <div class="about-list-infor">基于自然语言处理技术，结合基于大数据挖掘产生的知识图谱及相关技术，对人类自然语言进行分析、理解、生成、翻译，实现自然的人机对话交互。百度情感分析、英法机器翻译、句法分析、命名实体识别在国际标准评测集上世界第一。<br>
        提供的主要功能：<br>
    ...
    <div class="about-list-infor">贯通海量大数据，搭建用户画像独有模型，挖掘用户特征标签，体系化地勾勒用户全貌。精准识别用户的基本属性、行为习惯、兴趣爱好和消费需求，了解用户行为意图，根据用户不同的行为特点贴标签、绘制画像，应用于各个领域。<br>
        提供的主要功能：<br>
        &radic; 用户画像：用户画像平台<br>
        &radic; 推荐云平台：推荐云平台
    </div>
    <div class="about-list-two-title">5. 其他-AR</div>
    <div class="about-list-infor">利用百度大脑的技术和计算能力，在物体识别、三维环境感知、人机交互等核心方向都建立了绝对优势。<br>
    ...
    <div class="about-list-infor">API 直接调用：通过接口形式，直接调用百度大脑各项能力。</div>
    <div class="about-list-two-title">2. SDK</div>
    <div class="about-list-infor">移动端&服务端应用SDK：获得开放能力，适合离在线场景，支持java/php等语言，支持 Android / iOS等平台。</div>
    <div class="about-list-two-title">使用流程</div>
    <img class="about-list-img" width="840" src="/ai_images/support/about-us/lc-pic.png">
</section>
{%if $userInfo eq Null%}
