...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1494475882/css/document/document.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
                    ...
                    <ul class="level2 submenu">
                        ...
                        <li class="non-leaf">
                            ...
                            <ul class="level3 submenu">
                                ...
                                <li class="non-leaf sdk-node"
                                    data-md="OCR-Android-SDK">
                                    <a href="javascript:void(0)"><i></i>Android</a>
                                </li>
                                <li class="non-leaf sdk-node"
                                    data-md="OCR-iOS-SDK">
                                    <a href="javascript:void(0)"><i></i>iOS</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="level2 submenu">
                        <li class="non-leaf">
                            ...
                            <ul class="level3 submenu">
                                ...
                                <li class="leaf" data-md="FACE-API">
                                    <a href="javascript:void(0)"><i></i>人脸检测</a>
                                </li>
                                <li class="leaf" data-md="FACE-API">
...
<script src="//ai.bdstatic.com/dist/1494475882/js/document/document.js"></script>
