...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1493288513/css/secondary/nlp.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<div class="ai-platform page-content">
    ...
    <div class="ai-container">
        ...
        <div class="tech-banner-info">
            提供国际领先的自然语言处理技术，帮助你的产品更好的理解这个世界
        </div>
        ...
        <div class="tech-catalog-gallery">
            <div class="tech-prod-container">
                <div class="tech-prod-info">
                    <div class="tech-prod-name">词法分析</div>
                    <div class="tech-prod-intro">
                        输入内容即可获得切分后的词序列、识别出词性及专有名词
                    </div>
            ...
            <div class="tech-prod-container">
                <div class="tech-prod-info">
                    <div class="tech-prod-name">中文词向量</div>
                    <div class="tech-prod-intro">
                        输入单个中文词语，即可获得该词语的向量表示
                    </div>
                    <div class="tech-prod-panel">
                        <a class="ai-redirect"
                           href="https://console.bce.baidu.com/ai/?fromai=1#/ai/nlp/overview/index"
            ...
            <div class="tech-prod-container">
                <div class="tech-prod-info">
                    <div class="tech-prod-name">评论观点抽取</div>
                    <div class="tech-prod-intro">
                        自动分析用户评论，输出评论观点与情感极性
                    </div>
                    <div class="tech-prod-panel">
                        <a class="ai-redirect"
                           href="https://console.bce.baidu.com/ai/?fromai=1#/ai/nlp/overview/index"
            ...
            <div class="tech-prod-container">
                <div class="tech-prod-info">
                    <div class="tech-prod-name">机器翻译</div>
                    <div class="tech-prod-intro">
                        支持全球28种语言实时互译，服务稳定性高达99.99%
                    </div>
                    <div class="tech-prod-panel">
                        <a class="ai-redirect"
            ...
            <div class="ai-container">
                ...
                <div class="tech-case-item-info">
                    ...
                    <div class="tech-case-coop">
                        <div>合作案例:</div>
                        <img src="//ai.bdstatic.com/dist/1493288513/ai_images/technology/nlp/customer-1-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="tech-case-item tech-case-item-2">
            <div class="ai-container">
                ...
                <div class="tech-case-item-info">
                    ...
                    <div class="tech-case-coop">
                        <div>合作案例:</div>
                        <img src="//ai.bdstatic.com/dist/1493288513/ai_images/technology/nlp/customer-1-2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="tech-case-item tech-case-item-3">
            <div class="ai-container">
                ...
                <div class="tech-case-item-info">
                    ...
                    <div class="tech-case-coop">
                        <div>合作案例:</div>
                        <img src="//ai.bdstatic.com/dist/1493288513/ai_images/technology/nlp/customer-1-3.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="tech-feature-list tech-clear">
        <div class="tech-feature-item tech-feature-shadow">
            ...
            <div class="tech-feature-desc">
                <div class="tech-feature-desc-title">算法多样</div>
                <div class="tech-feature-desc-info">
                    数十种自然语言核心算法与解决方案，全面覆盖语言理解的各类需求
                </div>
            </div>
        </div>
        <div class="tech-feature-item tech-feature-shadow">
            ...
            <div class="tech-feature-desc">
                <div class="tech-feature-desc-title">接口易用</div>
                <div class="tech-feature-desc-info">标准化接口封装，通过云计算调用可快速使用工具，大大降低开发人力成本</div>
            </div>
        </div>
        <div class="tech-feature-item tech-feature-shadow">
            <div class="tech-feature-icon tech-feature-icon-3"></div>
            <div class="tech-feature-desc">
                <div class="tech-feature-desc-title">服务可靠</div>
                <div class="tech-feature-desc-info">
                    SLA稳定保持99.99%以上，支持千亿量级调用需求，配有完善的统计和监控措施
                </div>
            </div>
        </div>
    </div>
...
<script src="//ai.bdstatic.com/dist/1493288513/js/secondary/nlp.js"></script>
