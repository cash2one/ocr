...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495707314/css/secondary/template.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<div class="tech-section tech-guide">
    <a role="button"
       class="tech-guide-title btn-primary large-new consult">
        免费试用
    </a>
    <div class="ai-container">
...
<script src="//ai.bdstatic.com/dist/1495707314/js/secondary/template.js"></script>
