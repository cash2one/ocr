...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1491541563/css/secondary/speech.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<script src="//ai.bdstatic.com/dist/1491541563/js/secondary/speech.js"></script>
