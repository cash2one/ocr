...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495707314/css/secondary/speech.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
            ...
            <div class="ai-container">
                ...
                <div class="tech-case-item-info">
                    ...
                    <div class="tech-case-coop">
                        <div>合作案例:</div>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/speech/customer-1-1.png" alt="">
                        <div>
                            百度地图
                        </div>
                    </div>
        ...
        <div class="tech-case-item tech-case-item-2">
            <div class="ai-container">
                ...
                <div class="tech-case-item-info">
                    ...
                    <div class="tech-case-coop">
                        <div>合作案例:</div>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/speech/customer-2-1.png" alt="iReader">
                        <div>iReader</div>
                    </div>
                </div>
            </div>
        ...
        <div class="tech-case-item tech-case-item-3">
            <div class="ai-container">
                ...
                <div class="tech-case-item-info">
                    ...
                    <div class="tech-case-coop">
                        <div>合作案例:</div>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/speech/case-logo-4.png">
                        <div>手机百度</div>
                    </div>
                </div>
            </div>
...
<script src="//ai.bdstatic.com/dist/1495707314/js/secondary/speech.js"></script>
