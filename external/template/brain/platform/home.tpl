        ...
        <div class="solution-container">
            <div class="solution-detail">
                ...
                <div id="face-mobile-detect" class="solution-desc">
                    <h3>人脸核身</h3>
                    <div>
                        <p>解决金融等高风险行业线下复杂的身份验证流程</p>
                        <p>通过用户自拍照、身份证照等，在线人脸识别以确认用户身份</p>
                ...
                <div id="face-gate" class="solution-desc">
                    <h3>人脸闸机</h3>
                    <div>
                        <p>基于世界领先的深度学习算法，为客户提供多种场景的产品解决方案</p>
...
<section class="register-now home-section">
    <div class="container">
        ...
        <div>
            <a role="button" class="btn-normal large" href="https://login.bce.baidu.com?fromai=1&redirect=encodeURIComponent(https://console.bce.baidu.com/)">免费试用</a>
        </div>
    </div>
</section>
{%/if%}
