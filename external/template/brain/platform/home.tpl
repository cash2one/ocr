...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1493904938/css/home.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
    ...
    <ul class="banner-content">
        ...
        <li>
            <div class="banner-item">
                ...
                <div>
                    <a href="/tech/video/vca" class="get-started">了解详情</a>
                </div>
            </div>
        </li>
        <li>
        ...
        <li>
            <div class="banner-item">
                ...
                <div>
                    <a href="/tech/nlp/lexical" class="get-started">了解详情</a>
                </div>
            </div>
        </li>
        <li>
                ...
                <a href="http://www.chuanke.com/v7867982-208144-1278714.html"
                   target="_blank">
                    <img alt="百度语音基础介绍及应用场景"
                         width="500"
                         height="280"
                         src="//ai.bdstatic.com/dist/1493904938/ai_images/home/video-1.png">
                </a>
                <h5>百度语音基础介绍及应用场景</h5>
            </li>
            <li>
                <a href="http://www.chuanke.com/v7867982-208539-1278740.html"
                   target="_blank">
                    <img alt="百度OCR基础介绍及应用场景"
                         width="500"
                         height="280"
                         src="//ai.bdstatic.com/dist/1493904938/ai_images/home/video-2.png">
                </a>
                ...
                <a href="http://www.chuanke.com/v7867982-208540-1278742.html"
                   target="_blank">
                    <img alt="百度人脸技术基础介绍及引用场景"
                        width="500"
                        height="280"
                        src="//ai.bdstatic.com/dist/1493904938/ai_images/home/video-3.png">
                </a>
            ...
            <li>
                <a
                    ...
                    <img alt="百度翻译产品介绍"
                         width="500"
                         height="280"
                         src="//ai.bdstatic.com/dist/1493904938/ai_images/home/video-4.png">
                </a>
                <h5>百度翻译产品介绍</h5>
            </li>
        </ul>
...
<script src="//ai.bdstatic.com/dist/1493904938/js/home.js"></script>
