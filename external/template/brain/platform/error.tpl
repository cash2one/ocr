...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1493288513/css/error.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<div class="ai-platform page-content">
    ...
    <img src="//ai.bdstatic.com/dist/1493288513/ai_images/error/site-error.png">
    <p>对不起，页面出错啦!</p>
    <div>
...
<script src="//ai.bdstatic.com/dist/1493288513/js/error.js"></script>
