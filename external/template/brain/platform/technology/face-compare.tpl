...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495804556/css/technology/face-compare.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<script src="//ai.bdstatic.com/dist/1495804556/js/technology/face-compare.js"></script>
