...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1493288513/css/technology/face-compare.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<script src="//ai.bdstatic.com/dist/1493288513/js/technology/face-compare.js"></script>
