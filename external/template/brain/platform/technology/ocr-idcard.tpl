...
<head>
    ...
    <link rel="stylesheet" href="/ai_dist/1486524138/css/technology/ocr-idcard.style.css">
</head>
        ...
        <div class="demo-container clear-float">
            ...
            <div class="data-view">
                ...
                <ul class="demo-card-list clear-float">
                    <li>
                        <img src="/ai_dist/1486524138/ai_images/technology/ocr-idcard/demo-card-1.png">
                    </li>
                    <li>
                        <img src="/ai_dist/1486524138/ai_images/technology/ocr-idcard/demo-card-2.png">
                    </li>
                    <li>
                        <img src="/ai_dist/1486524138/ai_images/technology/ocr-idcard/demo-card-3.png">
                    </li>
                    <li>
                        <img src="/ai_dist/1486524138/ai_images/technology/ocr-idcard/demo-card-4.png">
                    </li>
                    <li>
                        <img src="/ai_dist/1486524138/ai_images/technology/ocr-idcard/demo-card-5.png">
                    </li>
                    <li>
                        <img src="/ai_dist/1486524138/ai_images/technology/ocr-idcard/demo-card-6.png">
                    </li>
                </ul>
            </div>
...
<script src="/ai_dist/1486524138/js/technology/ocr-idcard.js"></script>
</body>
</html>
