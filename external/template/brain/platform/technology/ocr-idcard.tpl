...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495804556/css/technology/ocr-idcard.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
        ...
        <div class="demo-container clear-float">
            ...
            <div class="data-view">
                ...
                <ul class="demo-card-list clear-float">
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-idcard/demo-card-1.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-idcard/demo-card-2.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-idcard/demo-card-3.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-idcard/demo-card-4.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-idcard/demo-card-5.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-idcard/demo-card-6.png">
                    </li>
                </ul>
            </div>
        ...
        <div class="scene-list clear-float">
            <div class="scene-item shadow">
                ...
                <div class="scene-desc">
                    <h3>金融场景</h3>
                    <p>银行保险券商等行业用于客户身份识别，身份信息绑定，个人信息核实等场景，减少身份证输入操作，提高工作效率和用户的体验</p>
                </div>
            </div>
            <div class="scene-item shadow">
                <div class="scene-icon"></div>
...
<script src="//ai.bdstatic.com/dist/1495804556/js/technology/ocr-idcard.js"></script>
