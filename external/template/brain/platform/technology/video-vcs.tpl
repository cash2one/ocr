...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495804556/css/technology/video-vcs.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
    ...
    <div class="ai-container">
        ...
        <div class="tech-banner-btn-list">
            <a role="button"
               ...
               href="https://cloud.baidu.com/survey/VCSApply.html?from=ai"
               {%else%}
               class="btn-primary media"
               href="/survey/VCSApply.html"
               {%/if%}>
            商务合作
            </a>
        </div>
    ...
    <div class="ai-container">
        ...
        <div class="tech-function-detail">
            ...
            <div class="scan-box">
                ...
                <div class="scan-box-connent">
                    对抽取出的若干封面进行图像质量分析，挑选出清晰度高、画面优质的一帧，作为封面
                </div>
            </div>
        </div>
    </div>
</div>
<div class="tech-section tech-demo" id="vcs-demo">
...
<script src="//ai.bdstatic.com/dist/1495804556/js/technology/video-vcs.js"></script>
