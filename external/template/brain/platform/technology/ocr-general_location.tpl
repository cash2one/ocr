...
<div class="tech-section tech-function">
    <div class="ai-container">
        ...
        <div class="tech-function-info">
            支持多场景下正图文字检测、定位、识别支持任意场景、复杂背景、任意版面识别，
            ...
            <div class="tech-demo-choose">
                ...
                <div class="tech-demo-card-list">
                    <div class="tech-demo-card-item tech-demo-card-active">
                        <img src="//ai.bdstatic.com/dist/1490342487/ai_images/technology/ocr-general_location/demo-card-1.jpeg" alt=" ">
                    </div>
                    ...
                    <div class="tech-demo-card-item">
                        <img src="//ai.bdstatic.com/dist/1490342487/ai_images/technology/ocr-general_location/demo-card-4.jpg" alt=" ">
                    </div>
                    <div class="tech-demo-card-item">
                    ...
                    <div class="tech-demo-card-item">
                        <img src="//ai.bdstatic.com/dist/1490342487/ai_images/technology/ocr-general_location/demo-card-7.jpeg" alt=" ">
                    </div>
                    <div class="tech-demo-card-item">
        ...
        <div class="tech-product-wrapper">
            <div class="product-box-1">
                ...
                <div class="box-body">
                    ...
                    <div class="box-body-connent">0.20元/次</div>
            ...
            <div class="product-box-3">
                ...
                <div class="box-body">
                    <div class="box-body-connent">
                        支付失败类型共分两种：服务错误和业务操作错误导致的调用失败超出免配额后，
