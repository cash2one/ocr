...
<link rel="stylesheet" href="/ai_dist/css/technology/nlp-lexical.css"></head>
...
<script src="/ai_dist/js/technology/nlp-lexical.bundle.js"></script></body>
</html>