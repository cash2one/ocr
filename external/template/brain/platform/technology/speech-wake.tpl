...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1490250326/css/technology/speech-wake.style.css">
</head>
...
<script src="//ai.bdstatic.com/dist/1490250326/js/technology/speech-wake.js"></script>
<script>
    (function(){
