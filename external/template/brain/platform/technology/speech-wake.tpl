...
<link rel="stylesheet" href="/ai_dist/css/technology/speech-wake.css"></head>
...
<section class="tech-section tech-banner">
    <div class="container">
        <h1>语音唤醒</h1>
        <p>支持指定词的指令唤醒，唤醒的同时执行指令操作<br>轻量级，低功耗，可自定义设置多个唤醒词</p>
        <div>
...
<script src="/ai_dist/js/technology/speech-wake.bundle.js"></script></body>
</html>