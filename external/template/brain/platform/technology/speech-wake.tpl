...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1488425849/css/technology/speech-wake.style.css">
</head>
    ...
    <div class="container">
        ...
        <div class="feature-list clear-float">
            ...
            <div class="feature-item shadow">
                ...
                <div class="feature-desc">
                    <h3>易于集成</h3>
                    <p style="text-align: center;">轻量级，功耗低</p>
                </div>
            </div>
            <div class="feature-item shadow">
                <div class="feature-icon"></div>
...
<script src="//ai.bdstatic.com/dist/1488425849/js/technology/speech-wake.js"></script>
</body>
</html>
