...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1493904938/css/technology/ar.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
    ...
    <div class="container">
        ...
        <div class="clear-float">
            <div class="flow-chart">
                <img src="//ai.bdstatic.com/dist/1493904938/ai_images/technology/ar/process-flow.png">
            </div>
...
<script src="//ai.bdstatic.com/dist/1493904938/js/technology/ar.js"></script>
