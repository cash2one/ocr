...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1493904938/css/technology/video-vca.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
    ...
    <div class="ai-container">
        ...
        <div class="tech-function-detail">
            ...
            <div class="scan-box">
                ...
                <div class="scan-box-connent">
                    分别对视频中的语音、文字、人脸（包含明星人脸及人脸属性）、物体进行智能化识别
                </div>
            </div>
            <div class="scan-box">
                <div class="scan-box-image"></div>
                ...
                <div class="scan-box-connent">
                    基于自然语言处理（NLP），对抽取文本内容提取关键词，并将各个维度内容进行多次校对，得到最精准的标签
                </div>
            </div>
            <div class="scan-box">
                <div class="scan-box-image"></div>
...
<div class="tech-section tech-demo" id="vca-demo">
...
<script src="//ai.bdstatic.com/dist/1493904938/js/technology/video-vca.js"></script>
