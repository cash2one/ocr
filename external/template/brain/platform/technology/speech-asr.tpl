...
<head>
    ...
    <link rel="stylesheet" href="/ai_dist/1488185410/css/technology/speech-asr.style.css">
</head>
...
<div class="tech-section tech-function">
    <div class="ai-container">
        ...
        <div class="tech-function-pic">
            <img width="670" src="/ai_dist/1488185410/ai_images/technology/speech-asr/intro.png" >
        </div>
    </div>
</div>
...
<script src="/ai_dist/1488185410/js/technology/speech-asr.js"></script>
</body>
</html>
