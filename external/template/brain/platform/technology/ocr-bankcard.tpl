        ...
        <div class="demo-container clear-float">
            ...
            <div class="data-view">
                ...
                <ul class="demo-card-list clear-float">
                    ...
                    <li>
                        <img src="/ai_images/technology/ocr-bankcard/demo-card-2.png">
                    </li>
                    <li>
                        <img src="/ai_images/technology/ocr-bankcard/demo-card-3.png">
                    </li>
                    <li>
                        <img src="/ai_images/technology/ocr-bankcard/demo-card-4.png">
                    </li>
                    <li>
                        <img src="/ai_images/technology/ocr-bankcard/demo-card-5.png">
                    </li>
                    <li>
                        <img src="/ai_images/technology/ocr-bankcard/demo-card-6.png">
                    </li>
                </ul>
            </div>
