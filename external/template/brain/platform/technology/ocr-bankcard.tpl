...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495707314/css/technology/ocr-bankcard.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<div class="ai-platform page-content">
    ...
    <div class="container">
        ...
        <div>
            ...
            <a role="button"
               class="btn-primary media ai-redirect"
               href="https://console.bce.baidu.com/ai/#/ai/ocr/order/create~serviceType=bcn_ocr">
                开通付费
            </a>
            <a class="tech-docs"
               href="
        ...
        <div class="tech-billing">
            价格大幅下调，千次调用低至<span class="price">9元</span>，
            <a target="_blank"
        ...
        <div class="demo-container clear-float">
            ...
            <div class="data-view">
                ...
                <ul class="demo-card-list clear-float">
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/ocr-bankcard/demo-card-1.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/ocr-bankcard/demo-card-2.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/ocr-bankcard/demo-card-3.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/ocr-bankcard/demo-card-4.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/ocr-bankcard/demo-card-5.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495707314/ai_images/technology/ocr-bankcard/demo-card-6.png">
                    </li>
                </ul>
            </div>
        ...
        <div class="tech-product-wrapper">
            <div class="product-form-1">
                ...
                <div class="product-body pric-body-1">
                    ...
                    <div class="pric-item-connent pric-item-1">0.02元/次</div>
                    <div class="pric-item-connent pric-item-1">5w&lt;调用量&lt;=10w</div>
                    <div class="pric-item-connent pric-item-1">0.016元/次</div>
                    <div class="pric-item-connent pric-item-1">10w&lt;调用量&lt;=20w</div>
                    <div class="pric-item-connent pric-item-1">0.013元/次</div>
                    <div class="pric-item-connent pric-item-1">20w&lt;调用量&lt;=50w</div>
                    <div class="pric-item-connent pric-item-1">0.011元/次</div>
                    ...
                    <div class="pric-item-connent pric-item-1">0.009元/次</div>
...
<script src="//ai.bdstatic.com/dist/1495707314/js/technology/ocr-bankcard.js"></script>
