...
<link rel="stylesheet" href="/dist/css/technology/face-detect.css"></head>
        ...
        <div class="demo-container clear-float">
            ...
            <div>
                <ul class="demo-card-list clear-float">
                    <li>
                        <img src="/ai_images/technology/bfr-detect/demo-card-1.jpg">
                    </li>
                    <li>
                        <img src="/ai_images/technology/bfr-detect/demo-card-2.jpg">
                    </li>
                    <li>
                    ...
                    <li>
                        <img src="/ai_images/technology/bfr-detect/demo-card-5.jpg">
                    </li>
                    <li>
                        <img src="/ai_images/technology/bfr-detect/demo-card-6.jpg">
                    </li>
                    <li>
                        <img src="/ai_images/technology/bfr-detect/demo-card-7.jpg">
                    </li>
                    <li>
                        <img src="/ai_images/technology/bfr-detect/demo-card-8.jpg">
                    </li>
                </ul>
            </div>
        </div>
...
<script src="/dist/js/technology/face-detect.bundle.js"></script></body>
</html>