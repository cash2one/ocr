...
<link rel="stylesheet" href="/ai_dist/css/technology/face-search.css"></head>
...
<section class="tech-section tech-banner">
    <div class="container">
        <h1>人脸查找</h1>
        <p>基于1：N图像匹配比对<br>轻松从人脸库中识别用户身份或相似人脸</p>
        <div>
...
<script src="/ai_dist/js/technology/face-search.bundle.js"></script></body>
</html>