...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1489043769/css/technology/speech-tts.style.css">
</head>
...
<script src="//ai.bdstatic.com/dist/1489043769/js/technology/speech-tts.js"></script>
<script>
    (function(){
