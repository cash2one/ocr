...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1492140185/css/technology/speech-tts.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<section class="tech-section tech-guide">
    <div class="container">
        ...
        <div class="guide-link clear-float">
            <h3>开发指南</h3>
            <ul>
                <li><a href="/docs#/TTS-Android-SDK">技术文档 ></a></li>
...
<script src="//ai.bdstatic.com/dist/1492140185/js/technology/speech-tts.js"></script>
