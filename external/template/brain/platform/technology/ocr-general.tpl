...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495804556/css/technology/ocr-general.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
        ...
        <div class="demo-container clear-float">
            ...
            <div class="data-view">
                ...
                <ul class="demo-card-list clear-float">
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-1.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-2.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-3.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-4.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-5.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-6.jpg">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-7.png">
                    </li>
                    <li>
                        <img src="//ai.bdstatic.com/dist/1495804556/ai_images/technology/ocr-general/demo-card-8.png">
                    </li>
                </ul>
            </div>
        ...
        <div class="feature-list clear-float">
            <div class="feature-item shadow">
                ...
                <div class="feature-desc">
                    <h3>准确性高</h3>
                    <p>国内首个公有云OCR产品，基于百度深度学习研究院（IDL）强大的深度学习算法和中文检测识别技术，整图中文识别准确率达85%以上，英文91%以上</p>
                </div>
            </div>
            <div class="feature-item shadow">
                <div class="feature-icon"></div>
                <div class="feature-desc">
                    <h3>成熟稳定</h3>
                    <p>经过手机百度、百度翻译、涂书笔记、百度糯米等多款重量级产品实践检验，产品成熟稳定。支持实时文字识别能力、弹性灵活的高并发承载及99.95%的可用性保证</p>
                </div>
            </div>
            <div class="feature-item shadow">
                <div class="feature-icon"></div>
                <div class="feature-desc">
                    <h3>简单易用</h3>
                    <p>提供符合RESTful规范的API访问接口及服务端SDK，使用便捷</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="scene-list clear-float">
            <div class="scene-item shadow">
                ...
                <div class="scene-desc">
                    <h3>通用自然场景</h3>
                    <p>印刷文档识别，翻译文字识别，搜索识别，涂抹识别等通用自然场景</p>
                </div>
            </div>
            <div class="scene-item shadow">
                <div class="scene-icon"></div>
            ...
            <div class="scene-item shadow">
                ...
                <div class="scene-desc">
                    <h3>医疗场景</h3>
                    <p>提供医疗行业的票据识别功能，减少人工输入过程，提高输入效率</p>
                </div>
            </div>
            <div class="scene-item shadow">
                <div class="scene-icon"></div>
            ...
            <div class="scene-item shadow">
                ...
                <div class="scene-desc">
                    <h3>视频场景</h3>
                    <p>用于视频字幕识别，视频标题识别，视频反作弊，头像反作弊，评论反作弊等</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <ul class="case-list">
        <li class="case-item active">
            <div class="container">
                ...
                <h2>百度翻译</h2>
                <p>百度翻译手机版提供中英日韩等10多个语种的文本互译<br>
                    使用OCR技术实现拍照整屏实时翻译、菜单翻译、涂抹翻译、取词翻译等功能，无需键盘输入，提升用户体验</p>
            </div>
        </li>
        <li class="case-item">
            <div class="container">
                <div class="case-icon"></div>
                <h2>涂书笔记</h2>
                <p>涂书笔记是一款纸质书文字摘录APP，入选了“App store 2014年度精选”<br>
                    用户拍摄书中感兴趣的内容，涂抹要摘录的文字，即可使用OCR技术进行实时识别、记录读书笔记，识别准确率95%以上<br>
                    识别速度快，准确率高，减少了用户的输入操作，有效的提高了用户的体验</p>
            </div>
        </li>
        <li class="case-item">
            <div class="container">
                <div class="case-icon"></div>
                <h2>快手</h2>
                <p>快手是中国领先的短视频共享平台<br>
                    快手调用百度OCR接口对短视频进行识别并进行是否作弊判断。有效的监测了短视频违规情况</p>
            </div>
        </li>
        <li class="case-item">
            <div class="container">
                ...
                <p>手机百度是百度推出的一款方便手机用户随时随地使用百度搜索服务的应用<br>
                    手机百度调用百度通用OCR接口进行多模拍照文字识别，发现题目，翻译文字等功能</p>
            </div>
        </li>
        <li class="case-item">
            <div class="container">
                <div class="case-icon"></div>
                <h2>百度地图</h2>
                <p>百度地图是百度提供的一项网络地图搜索服务<br>
                    百度地图调用百度通用OCR接口进行地图街景路牌，指示牌，商户招牌，门牌等街景文字信息的识别，进行地图信息标注和处理</p>
            </div>
        </li>
        <li class="case-item">
            <div class="container">
                <div class="case-icon"></div>
                <h2>百度外卖</h2>
                <p>百度外卖，是由百度打造的专业外卖服务平台<br>
                    百度外卖调用百度通用OCR接口进行外卖票据的识别服务，包括拍小票送餐等</p>
            </div>
        </li>
    </ul>
    <ul class="case-indicator">
        <li class="active"><a>百度翻译</a></li>
        <li><a>涂书笔记</a></li>
        <li><a>快手</a></li>
        <li><a>手机百度</a></li>
        <li><a>百度地图</a></li>
...
<script src="//ai.bdstatic.com/dist/1495804556/js/technology/ocr-general.js"></script>
