...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1492773116/css/technology/nlp-word_embedding.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<div class="tech-section tech-function">
    <div class="ai-container">
        ...
        <div class="tech-function-pic">
            <img width="500" src="//ai.bdstatic.com/dist/1492773116/ai_images/technology/nlp-word_embedding/function-pic.png" >
        </div>
    </div>
</div>
...
<script src="//ai.bdstatic.com/dist/1492773116/js/technology/nlp-word_embedding.js"></script>
