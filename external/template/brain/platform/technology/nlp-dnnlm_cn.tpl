...
<link rel="stylesheet" href="/ai_dist/css/technology/nlp-dnnlm_cn.css"></head>
...
<section class="tech-section tech-banner">
    <div class="container">
        <h1>中文DNN语言模型</h1>
        <p>依托全网海量优质数据和深度神经网络技术<br>精准判别文句是否符合客观语言表达习惯</p>
        <div>
...
<script src="/ai_dist/js/technology/nlp-dnnlm_cn.bundle.js"></script></body>
</html>