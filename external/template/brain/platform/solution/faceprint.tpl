...
<head>
    ...
    <![endif]-->
<link rel="stylesheet" href="/ai_dist/css/solution/faceprint.css"></head>
        ...
        <div class="solution-container">
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_images/solution/faceprint/solution-case-1.png">
                </div>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_images/solution/faceprint/solution-case-2.png">
                </div>
                <div class="solution-desc">
                    <h3>交互流畅</h3>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_images/solution/faceprint/solution-case-3.png">
                </div>
                <div class="solution-desc">
                    <h3>行业定制</h3>
