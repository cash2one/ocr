...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1495804556/css/solution/dialog.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
        ...
        <div class="solution-container">
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="//ai.bdstatic.com/dist/1495804556/ai_images/solution/dialog/solution-case-1.png">
                </div>
...
<script src="//ai.bdstatic.com/dist/1495804556/js/solution/dialog.js"></script>
