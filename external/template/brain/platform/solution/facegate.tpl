...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1492602425/css/solution/facegate.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
        ...
        <div class="solution-container">
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="//ai.bdstatic.com/dist/1492602425/ai_images/solution/facegate/solution-case-1.png">
                </div>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="//ai.bdstatic.com/dist/1492602425/ai_images/solution/facegate/solution-case-2.png">
                </div>
                <div class="solution-desc">
                    <h3>降低人力成本</h3>
                    <ul>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="//ai.bdstatic.com/dist/1492602425/ai_images/solution/facegate/solution-case-3.png">
                </div>
                <div class="solution-desc">
                    <h3>可配置的权限系统</h3>
                    <ul>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="//ai.bdstatic.com/dist/1492602425/ai_images/solution/facegate/solution-case-4.png">
                </div>
                <div class="solution-desc">
                    <h3>全天候稳定保障</h3>
                    <ul>
...
<script src="//ai.bdstatic.com/dist/1492602425/js/solution/facegate.js"></script>
