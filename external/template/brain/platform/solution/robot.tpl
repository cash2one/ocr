...
<head>
    ...
    <link rel="stylesheet" href="//ai.bdstatic.com/dist/1491467582/css/solution/robot.style.css">
    <script>
        var _hmt = _hmt || [];
        (function() {
        ...
        <div class="solution-container">
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="//ai.bdstatic.com/dist/1491467582/ai_images/solution/robot/solution-case-1.jpg">
                </div>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="//ai.bdstatic.com/dist/1491467582/ai_images/solution/robot/solution-case-2.jpg">
                </div>
                <div class="solution-desc">
                    <h3>商用场景方案</h3>
...
<script src="//ai.bdstatic.com/dist/1491467582/js/solution/robot.js"></script>
