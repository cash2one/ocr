...
<head>
    ...
    <link rel="stylesheet" href="/ai_dist/1484138428/css/solution/robot.style.css">
</head>
        ...
        <div class="solution-container">
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_dist/1484138428/ai_images/solution/robot/solution-case-1.jpg">
                </div>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_dist/1484138428/ai_images/solution/robot/solution-case-2.jpg">
                </div>
                <div class="solution-desc">
                    <h3>商用场景方案</h3>
...
<script src="/ai_dist/1484138428/js/solution/robot.js"></script>
</body>
</html>
