...
<div style="width: 1200px; margin: auto; min-height: 600px;">
    <form class="frm">
        <table style="width: 1200px;">
            <tr class="t-center">
                <td>内网&外网</td>
                <td><label><input type="radio"/><span>内网</span></label><label><input type="radio"/><span>外网</span></label></td>
            </tr>
            <tr class="t-center">
                <td>标题</td>
...
<script src="/index/static/brain/page/editnews/ckeditor/ckeditor.js"></script>
