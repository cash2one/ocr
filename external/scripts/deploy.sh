...
mkdir download
cd download
rm -f aip-antiporn-java-sdk-1.2.zip aip-antiporn-php-sdk-1.2.zip aip-face-java-sdk-1.2.zip aip-face-php-sdk-1.2.zip aip-nlp-java-sdk-1.2.zip aip-nlp-php-sdk-1.2.zip aip-ocr-java-sdk-1.2.zip aip-ocr-php-sdk-1.2.zip aip-python-sdk-1.2.zip
wget ftp://cp01-zhanghongguang-dev.epc.baidu.com/1.2/aip-antiporn-java-sdk-1.2.zip
wget ftp://cp01-zhanghongguang-dev.epc.baidu.com/1.2/aip-antiporn-php-sdk-1.2.zip
