...
<head>
    ...
    <link rel="stylesheet" href="/ai_dist/1484138428/css/solution/facegate.style.css">
</head>
        ...
        <div class="solution-container">
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_dist/1484138428/ai_images/solution/facegate/solution-case-1.png">
                </div>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_dist/1484138428/ai_images/solution/facegate/solution-case-2.png">
                </div>
                <div class="solution-desc">
                    <h3>降低人力成本</h3>
                    <ul>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_dist/1484138428/ai_images/solution/facegate/solution-case-3.png">
                </div>
                <div class="solution-desc">
                    <h3>可配置的权限系统</h3>
                    <ul>
            ...
            <div class="solution-case shadow">
                <div class="solution-icon">
                    <img src="/ai_dist/1484138428/ai_images/solution/facegate/solution-case-4.png">
                </div>
                <div class="solution-desc">
                    <h3>全天候稳定保障</h3>
                    <ul>
...
<script src="/ai_dist/1484138428/js/solution/facegate.js"></script>
</body>
</html>
