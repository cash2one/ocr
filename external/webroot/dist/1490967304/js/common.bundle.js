...
/******/ 	var parentJsonpFunction = window["duAI"];
/******/ 	window["duAI"] = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {
...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "1490967304/js/" + chunkId + ".js";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.news : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data) {
    var alias1=container.lambda, alias2=container.escapeExpression;

  return "            <li>\n                <a href=\"/support/news?action=detail&id="
    ...
    return "        <li><a href=\"#\">暂无新闻</a></li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<ul>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.news : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
    + "</ul>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"consult-loading\">\n    正在提交\n    <span class=\"loading-dot\">...........</span>\n</div>\n";
},"useData":true});
...
var _handlebarsBase = __webpack_require__(42);
...
var _handlebarsSafeString = __webpack_require__(121);
...
var _handlebarsRuntime = __webpack_require__(120);

var runtime = _interopRequireWildcard(_handlebarsRuntime);

var _handlebarsNoConflict = __webpack_require__(119);
...
var _helpersBlockHelperMissing = __webpack_require__(111);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(112);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(113);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(114);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(115);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(116);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(117);
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        key: 'init',
        value: function init() {
            var html = (0, _modal2.default)({ id: this.id, title: this.title });
...
var _logger = __webpack_require__(118);
...
var _news = __webpack_require__(76);

var _news2 = _interopRequireDefault(_news);

var _consultationModal = __webpack_require__(75);

var _consultationModal2 = _interopRequireDefault(_consultationModal);

var _subscriptionModal = __webpack_require__(77);
...
// 绑定视窗滚动事件
var defineHeight = $window.height() / 2;
$window.resize(function () {
    defineHeight = $window.height() / 2;
});
var backTop = (0, _jquery2.default)('.back-top');
var toggleBackTop = function toggleBackTop() {
    backTop.toggle($document.scrollTop() > defineHeight);
};
toggleBackTop();
$window.scroll((0, _lodash2.default)(toggleBackTop, 300));
...
if (window.location.hostname.indexOf('cloud.baidu.com') < 0) {
    ...
    if (query.hasOwnProperty('t') || query.hasOwnProperty('track')) {
        var iframe = (0, _jquery2.default)('<iframe class="ai-track"></iframe>');
        var iframeURL = 'https://cloud.baidu.com/helper/x.html' + location.search + '&stamp=' + new Date().getTime();
    ...
    (0, _jquery2.default)('.consult').on('click', function (e) {
        e.stopPropagation();
...
// FIXME 临时方案，很脏，有风险
(0, _jquery2.default)('a.ai-redirect').on('click', function (e) {
    var $target = (0, _jquery2.default)(e.target);
    e.preventDefault();

    var url = '';
    var originUrl = $target.attr('href');
...
var _consultation = __webpack_require__(78);

var _qrCode = __webpack_require__(41);

var _placeholder = __webpack_require__(40);

var _apply = __webpack_require__(97);

var _apply2 = _interopRequireDefault(_apply);

var _fail = __webpack_require__(98);

var _fail2 = _interopRequireDefault(_fail);

var _success = __webpack_require__(100);
...
var ConsultationModal = function (_Modal) {
    ...
    _createClass(ConsultationModal, [{
        ...
        value: function reset() {
            this.setContent((0, _apply2.default)({}));
            (0, _placeholder.setPlaceHolder)(this.getModal());
        }
    }, {
        key: 'apply',
        value: function apply() {
            this.setContent((0, _loading2.default)({}));
        }
    }, {
        key: 'applySuccess',
        value: function applySuccess() {
            this.setContent((0, _success2.default)({}));
        }
    }, {
        key: 'applyFail',
        value: function applyFail() {
            this.setContent((0, _fail2.default)({}));
        }
    }, {
        key: 'refreshQRCode',
        ...
        value: function bindEvent() {
            ...
            modal.on('click', 'button.submit', function (e) {
                ...
                var inputsToCheck = ['input[name=company]', 'input[name=username]', 'input[name=phone]', 'input[name=siteUrl]', '[name=requirement]', 'input[name=code]'];
                ...
                (0, _qrCode.checkQRCode)({
                    ...
                    success: function success(res) {
                        ...
                        (0, _consultation.sendConsultation)({
                            data: {
...
var _news = __webpack_require__(79);

var _news2 = __webpack_require__(102);
        ...
        value: function render() {
            ...
            (0, _news.getNews)({
                ...
                success: function success(res) {
                    ...
                    var html = (0, _news3.default)({ news: res.data });
...
var _subscription = __webpack_require__(80);
...
var _success = __webpack_require__(106);

var _success2 = _interopRequireDefault(_success);

var _fail = __webpack_require__(104);
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form id=\"consult-form\" class=\"ai-consult-form\">\n    <div class=\"ai-consult-form-title\">您希望咨询的技术：</div>\n    <div class=\"ai-consult-form-select\">\n        <label>\n            <select class=\"ai-consult-form-select-list\" name=\"tech\">\n                <option value=\"OCR文字识别\" selected>OCR文字识别</option>\n                <option value=\"人脸识别\">人脸识别</option>\n                <option value=\"黄反识别\">黄反识别</option>\n                <option value=\"语音技术\">语音技术</option>\n                <option value=\"NLP自然语言处理\">NLP自然语言处理</option>\n                <option value=\"用户画像\">用户画像</option>\n                <option value=\"机器学习\">机器学习</option>\n                <option value=\"AR增强现实\">AR增强现实</option>\n                <option value=\"机器人\">机器人</option>\n                <option value=\"人脸核身\">人脸核身</option>\n                <option value=\"人脸闸机\">人脸闸机</option>\n                <option value=\"号码风险识别\">号码风险识别</option>\n                <option value=\"我不确定\">我不确定</option>\n            </select>\n        </label>\n    </div>\n    <input class=\"ai-consult-form-enter ai-consult-form-input\"\n           type=\"text\" maxlength=\"50\" placeholder=\"请输入您的公司/单位名称（必填）\" name=\"company\">\n    <input class=\"ai-consult-form-enter ai-consult-form-input\"\n           type=\"text\" maxlength=\"50\" placeholder=\"请输入您的姓名/称呼（必填）\" name=\"username\">\n    <input class=\"ai-consult-form-enter ai-consult-form-input\"\n           type=\"text\" maxlength=\"50\" placeholder=\"请输入您的联系电话：手机/固定电话（必填）\" name=\"phone\">\n    <input class=\"ai-consult-form-enter ai-consult-form-input\"\n           type=\"text\" maxlength=\"50\" placeholder=\"请输入您的行业（选填）\" name=\"trade\">\n    <input class=\"ai-consult-form-enter ai-consult-form-input\"\n           type=\"text\" maxlength=\"100\" placeholder=\"请输入您的公司/单位网址（必填）\" name=\"siteUrl\">\n    <textarea class=\"ai-consult-form-enter ai-consult-form-text\"\n              placeholder=\"您的公司的业务简要介绍（选填）\" maxlength=\"500\" name=\"business\"></textarea>\n    <textarea class=\"ai-consult-form-enter ai-consult-form-text\"\n              placeholder=\"您对AI的需求介绍（必填）\" maxlength=\"500\" name=\"requirement\"></textarea>\n    <div class=\"qr-code-input\">\n        <input type=\"text\" maxlength=\"4\" placeholder=\"请输入正确的验证码\" name=\"code\">\n        <a>\n            <img alt=\"点击刷新验证码\" src=\"/index/seccode?action=show\">\n        </a>\n    </div>\n    <div class=\"info-warning\"></div>\n    <div class=\"form-actions\">\n        <button type=\"submit\" class=\"btn-primary submit\">提交需求</button>\n        <button type=\"button\" class=\"btn-normal cancel\">取消</button>\n    </div>\n</form>\n";
},"useData":true});
