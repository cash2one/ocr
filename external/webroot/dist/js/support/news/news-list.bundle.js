...
},{"./pager.js":3,"jquery":1}],3:[function(require,module,exports){
'use strict';
...
_jquery2.default.extend(_jquery2.default.fn, {
    page: function page(options) {
        ...
        function r3() {
            var t = '<div style="display: inline-block; vertical-align: middle">' + '<span style="margin-left: 20px"><form style="display: inline-block" class="sl-index" >' + '去第<input style="text-align: center; margin:0 10px;width: 32px;height: 32px;color: #646B7D;" ' + 'type="text" value="' + (now + 1) + '"/>页</form></span>' + '</div>';
            return t;
        }
