...
var DemoCanvas = function () {
    ...
    _createClass(DemoCanvas, [{
        key: 'checkByUrl',
        value: function checkByUrl(image) {
...
},{"../../model/demoAPI":4,"jquery":1}],3:[function(require,module,exports){
/**
 * @file bfb-人脸检测脚本入口
 * @author shiliang@baidu.com
 */
...
var _demoCanvas = require('../component/widget/demoCanvas');
...
(0, _jquery2.default)(document).ready(function () {
    ...
    (0, _jquery2.default)('.tech-intro-detail').one('demo', function () {
        (0, _jquery2.default)('.tech-intro-detail').addClass('scanned');
    });
    ...
    var resetDemo = function resetDemo() {
        ...
        (0, _jquery2.default)('#demo-photo-upload').val('');
        (0, _jquery2.default)('#result-gallery').toggle(false).find('ul').empty();
        (0, _jquery2.default)('#face-details').hide().empty();
    };

    // 画人脸结果区块
    var drawRect = function drawRect(data) {
        var canvas = (0, _jquery2.default)('#demo-result canvas');
        var scale = canvas.attr('data-scale');
        var ctx = (0, _jquery2.default)('#demo-result canvas')[0].getContext('2d');
    ...
    var toggleGallery = function toggleGallery(isOpen) {
        (0, _jquery2.default)('#result-gallery').toggle(isOpen);
    };

    // 初始画廊
    var setGalleryContent = function setGalleryContent(data) {
        var galleryList = (0, _jquery2.default)('#result-gallery > ul');
    ...
    var showScanResult = function showScanResult(data, isAll) {
        var details = (0, _jquery2.default)('#face-details');
        details.empty();
        if (isAll) {
            details.hide();
            return false;
        ...
        for (var i in FACE_PROPERTY_DICT) {
            if (data.hasOwnProperty(i)) {
                var label = FACE_PROPERTY_DICT[i].name;
                var value = FACE_PROPERTY_DICT[i].transform(data[i]);
                details.append((0, _jquery2.default)('<li></li>').html(label + ' : ' + value));
            }
        }
    };

    var startScan = function startScan(type, imgSrc) {
        (0, _jquery2.default)('#demo-json > p').empty();
        toggleGallery(false);
        ...
        var options = {
            success: function success(res) {
                ...
                if (res.errno !== 0 || !res.data.result_num) {
                    (0, _jquery2.default)('#demo-result .canvas-container').toggleClass('error-upload-fail', res.errno === 1).toggleClass('error-timeout', res.errno === 28).toggleClass('error-image-format', res.errno === 216201).toggleClass('error-no-result', !res.data.result_num);
    ...
    (0, _jquery2.default)('#scan-photo').click(function () {
        ...
        new _demoCanvas2.default({
            selector: '#demo-result .canvas-container',
            image: (0, _jquery2.default)('#demo-photo-url').val(),
            type: 'url',
            success: function success(imgSrc) {
    ...
    // 绑定实例图点击事件
    (0, _jquery2.default)('.demo-card-list > li').click(function () {
        if (isScanning) {
            alert('操作正在进行中，请稍候再试！');
            return;
        }
        ...
        var imgSrc = window.location.origin + (0, _jquery2.default)(this).find('img').attr('src');
        (0, _jquery2.default)('#demo-photo-upload, #scan-photo').addClass('disabled');
        new _demoCanvas2.default({
            selector: '#demo-result .canvas-container',
            image: imgSrc,
    ...
    // 结果画廊点击事件
    (0, _jquery2.default)('#result-gallery').on('click', 'li', function () {
        (0, _jquery2.default)('#result-gallery li').removeClass('active');
        var galleryItem = (0, _jquery2.default)(this);
        galleryItem.addClass('active');
        var faceData = galleryItem.data('face');
        var isAll = galleryItem.data('isAll');
...
},{"../component/widget/demoCanvas":2,"../model/demoAPI":4,"jquery":1}],4:[function(require,module,exports){
/**
 * @file demo API接口定义
 * @author shiliang@baidu.com
 */
