...
var DemoCanvas = function () {
    ...
    _createClass(DemoCanvas, [{
        ...
        value: function render() {
            ...
            var canvas = (0, _jquery2.default)('<canvas>').attr('width', iWidth).attr('height', iHeight);
            ...
            var scaleRatio = wRatio > 1 || hRatio > 1 ? 1 / (wRatio >= hRatio ? wRatio : hRatio) : 1;
        ...
        var options = {
            success: function success(res) {
                ...
                if (res.errno !== 0) {
                    ...
                    (0, _jquery2.default)('#demo-result .result-background').empty();
                    return false;
                }
                var hasNoResult = !res.data.result_num;
                ...
                for (var i = 0, len = res.data.result_num; i < len; i++) {
...
function getHeader(_ref5) {
    var _ref5$imageUrl = _ref5.imageUrl,
