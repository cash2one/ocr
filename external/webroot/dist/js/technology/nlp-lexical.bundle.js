...
var paintDemo = function paintDemo(demoNum) {
    ...
    var termTmp = {};
    // 填充专业名词
    termsData[demoNum].forEach(function (_ref3) {
        var type = _ref3.type,
            block = _ref3.block;
    ...
    try {
        for (var _iterator = Object.keys(termTmp)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var termNameEng = _step.value;
...
// 切换tab
$lexerDemoTabLabel.find('.lexer-demo-tab-label').on('click', function (_ref4) {
