...
/***/ function(module, exports, __webpack_require__) {
	...
	var paintDemo = function paintDemo(demoNum) {
	    ...
	    sentencesGroup[demoNum].forEach(function (sentence, sentenceIndex) {
	        ...
	        analyzeResult.forEach(function (_ref) {
	    ...
	    sentenceDataArray.forEach(function (sentenceData, caseIndex) {
	        // 一条评论的html
	        var commentHTML = sentenceData.map(function (_ref2) {
	            var word = _ref2.word,
	                attitude = _ref2.attitude;
	    ...
	    // 右侧绘图
	    Object.keys(existTagData).forEach(function (tagName) {
	        // 一个tag的正反向值
