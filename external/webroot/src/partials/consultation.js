...
export const CONSULTATION_TMPL = {
    'APPLY': [
        '<form id="consult-form">',
            ...
            '</div>',
            '<div>',
                '<input type="text" maxlength="50"  placeholder="请输入您的公司/单位名称（必填）" ',
                'value="请输入您的公司/单位名称（必填）" name="company">',
            '</div>',
            '<div>',
                '<input type="text" maxlength="50" placeholder="请输入您的姓名/称呼（必填）" ',
                'value="请输入您的姓名/称呼（必填）" name="username">',
            '</div>',
            '<div>',
                '<input type="text" maxlength="50" placeholder="请输入您的联系电话：手机/固定电话（必填）" ',
                'value="请输入您的联系电话：手机/固定电话（必填）" name="phone">',
            '</div>',
            '<div>',
                '<input type="text" maxlength="50"  placeholder="请输入其他联系方式：邮箱/QQ等（选填）" ',
                'value="请输入其他联系方式：邮箱/QQ等（选填）" name="contactWay">',
            '</div>',
            '<div>',
                '<textarea placeholder="请输入您的合作方式及内容，限500字内" maxLenght="500" name="content" ',
                'value="请输入您的合作方式及内容，限500字内"></textarea>',
            '</div>',
