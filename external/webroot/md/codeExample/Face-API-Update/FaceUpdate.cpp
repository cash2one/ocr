...
// 接口url
const static std::string update_user_url = "https://aip.baidubce.com/rest/2.0/face/v2/faceset/user/update";
static std::string update_user_result;
...
static size_t callback(void *ptr, size_t size, size_t nmemb, void *stream) {
    ...
    update_user_result = std::string((char *) ptr, size * nmemb);
    return size * nmemb;
}
 ...
 */
int update_user(std::string &json_result, const std::string &uid, const std::vector<std::string> &images,
