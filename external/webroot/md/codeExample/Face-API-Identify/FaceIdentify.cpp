 ...
 */
int identify(std::string &json_result, const std::string &group_id, const std::vector<std::string> &images,
             const std::string &access_token, int user_top_num, int face_top_num) {
