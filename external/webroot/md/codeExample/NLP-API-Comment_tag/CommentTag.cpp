...
// 人脸检测接口url
const static std::string comment_tag_url = "https://aip.baidubce.com/rpc/2.0/nlp/v1/comment_tag";
 ...
 */
int comment_tag(std::string &json_result, const std::string &comment, const int type, const std::string &access_token) {
    std::string url = comment_tag_url + "?access_token=" + access_token;
    CURL *curl = NULL;
    CURLcode result_code;
    int is_success;
    // 将int类型的type转换为string类型
