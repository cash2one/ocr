...
{%require name="brain:page/deletenews/deletenews.css"%}
{%require name="brain:page/deletenews/deletenews.js"%}
{%/block%}
{%block name="header"%}
{%widget
...
{%require name='brain:page/deletenews/deletenews.tpl'%}{%/block%}
