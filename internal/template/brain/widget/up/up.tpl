<div class="top-section">
    <div class="top-pic">
            <a class="btn-bg-blue"
                style="position: absolute; height: 45px; width: 140px; left: 760px; top: 352px;"
            href="http://hetu.baidu.com/api/?categoryId=190" target="_blank"></a>
    </div>
</div>
<div class="intro-section" id="intro">
    <div class="intro-pic">
        <a href="http://idm.baidu.com" target="_blank">
            <div class="intro-detail" 
                style="left: 84px;"
            >查看详情</div>
        </a>
        <a href="http://idm.baidu.com/#product" target="_blank">
            <div class="intro-detail"
                style="left: 174px;"
            >技术体验</div>
        </a>
        <a href="http://erised.baidu.com" target="_blank">
            <div class="intro-detail"
                style="left: 513px;"
            >查看详情</div>
        </a>
        <a href="http://erised.baidu.com/erised/person" target="_blank">
            <div class="intro-detail"
                style="left: 603px;"
            >技术体验</div>
        </a>
        <a href="http://recsys.baidu.com" target="_blank">
            <div class="intro-detail"
                style="left: 945px;"
            >查看详情</div>
        </a>
        <a href="http://recsys.baidu.com/recsys/quickstart?tpl=index&doc=MovieDemo" target="_blank">
            <div class="intro-detail"
                style="left: 1035px;"
            >技术体验</div>
        </a>
...
<div class="product-section">
    <div class="product-pic" style="overflow: hidden;">
        ...
        <ul class="scroll-btn">
            <li class="tip-btn">新用户开拓</li>
            <li class="tip-btn">用户个性化补贴方案</li>
            <li class="tip-btn">WISE小说-猜你喜欢</li>
        </ul>
    </div>
</div>
<!--
...
{%script%}
    var up = require('brain:widget/up/up.js');
    up.init();
{%/script%}
