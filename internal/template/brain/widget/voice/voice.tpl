...
<div class="intro-section" id="intro">
    <div class="intro-pic">
        <a href="http://speech.baidu.com/asr" target="_blank">
            <div class="intro-detail" 
                style="left: 84px;"
            >查看详情</div>
        </a>
        <a href="http://speech.baidu.com/#try" target="_blank">
            <div class="intro-detail"
                style="left: 174px;"
            >技术体验</div>
        </a>
        <a href="http://speech.baidu.com/tts" target="_blank">
            <div class="intro-detail"
                style="left: 513px;"
            >查看详情</div>
        </a>
...
<div class="product-section">
    <div class="product-pic" style="overflow: hidden;">
        ...
        <ul class="scroll-btn">
            <li class="tip-btn">手百语音搜索</li>
            <li class="tip-btn">百度carlife</li>
            <li class="tip-btn">度秘语音交互</li>
            <li class="tip-btn">百度新闻</li>
        </ul>
    </div>
</div>
<!--
